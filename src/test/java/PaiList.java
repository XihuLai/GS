...
//    public static int[] p4 = {37,19,19,19,20,20,20,21,21,21,22,22,22,23};
    public static int[] p1 = {0,8,9,17,18,26,27,28,29,30,31,32,33,34};
    public static int[] p2 = {3,4,5,14,15,18,19,20,23,23,24,25,26,35};
    public static int[] p3 = {0,0,3,3,3,5,6,7,11,12,14,15,16,36};
    public static int[] p4 = {1,1,1,9,10,11,12,14,20,20,24,25,26,37};

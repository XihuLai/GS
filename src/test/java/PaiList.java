...
//    public static int[] p4 = {37,19,19,19,20,20,20,21,21,21,22,22,22,23};
    public static int[] p1 = {3,4,4,5,6,10,11,12,14,14,26,26,26,5};
    public static int[] p2 = {5,5,6,6,10,12,13,14,15,22,23,24,26,1};
    public static int[] p3 = {0,0,3,3,3,15,16,17,11,12,14,15,16,12};
    public static int[] p4 = {1,1,1,9,10,11,12,14,20,20,24,25,26,17};

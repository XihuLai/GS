...
public class Next2 {
    ...
    public static int avatarIndex = 3;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("--124 登陆结束...");

                System.out.println("--124 加入房间开始, roomId = " + args[0]);
                ...
                System.out.println("--124 加入房间开始结束...");


                System.out.println("--124 准备游戏开始...");
                //游戏开始测试

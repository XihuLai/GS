...
//    		int count  = huCount;
    ...
    public void settlementData(){
	  ...
	  if(count <= 0){
			...
			Map<Integer, Map<String, Integer>> endStatistics = roomVO.getEndStatistics();
			...
			for (Entry<Integer, Map<String, Integer>>  param : set) {
				obj = new FinalGameEndItemVo();
				obj.setUuid(param.getKey());
				map = param.getValue();

...
//    private Map<String , ArrayList<Integer>> gangAndHuInfos =  new HashMap<String, ArrayList<Integer>>(); 
    ...
    private Map<String,String> huInfo = new HashMap<String,String>();//返回胡牌的各种名堂比如清一色，碰碰胡等等
...
//	}
	...
	public Map<String, String> getHuInfo() {
		return huInfo;
	}
	public void setHuInfo(Map<String, String> huInfo) {
		this.huInfo = huInfo;
	}

...
public class HuReturnObjectVO {
     ...
     */
    private Map<Integer , ArrayList<Integer>> gangAndHuInfos; 
    /**
     * 昵称
     */
    ...
    public Map<Integer, ArrayList<Integer>> getGangAndHuInfos() {
     ...
     * @param score 分数
     */
	public synchronized void updateGangAndHuInfos(int type , int score) {
		if(gangAndHuInfos == null){
			this.gangAndHuInfos = new HashMap<Integer, ArrayList<Integer>>();
		}
